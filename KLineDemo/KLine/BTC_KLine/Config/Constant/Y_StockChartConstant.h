...
typedef NS_ENUM(NSInteger, Y_StockChartCenterViewType) {
    ...
    Y_StockChartcenterViewTypeMoreTime,  //更多时间
    Y_StockChartcenterViewTypeIndicator,  //指标
