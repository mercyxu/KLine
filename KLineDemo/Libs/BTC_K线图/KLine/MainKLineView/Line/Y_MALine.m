...
- (void)draw
{
    ...
    if (_MAType == Y_BOLL_DN || _MAType == Y_BOLL_MB || _MAType == Y_BOLL_UP){
        ...
        UIColor *lineColor = [UIColor ma7Color];
        if (self.MAType == Y_MA7Type) {
            lineColor = [UIColor ma7Color];
        } else if (self.MAType == Y_MA5Type) {
            lineColor = [UIColor ma5Color];
        } else if (self.MAType == Y_MA10Type) {
            lineColor = [UIColor ma10Color];
        } else if (self.MAType == Y_MA30Type) {
            lineColor = [UIColor ma30Color];
        } else {
            lineColor = [UIColor mainTextColor];
        }
        
        
        if (self.MAType == Y_TimeLine) {
            lineColor = kBlue100;
        }
