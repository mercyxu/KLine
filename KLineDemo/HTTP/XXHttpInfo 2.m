...
- (void)setHttpHeader:(NSMutableURLRequest *)request {
    ...
    [request setValue:screenSizeValue forHTTPHeaderField:@"screensize"];
    [request setValue:@"bhexApp" forHTTPHeaderField:@"app"];
    [request setValue:KUser.netWorkStatus forHTTPHeaderField:@"nett"];
    [request setValue:[self userAgent] forHTTPHeaderField:@"User-Agent"];
    [request setValue:[infoDic objectForKey:@"CFBundleShortVersionString"] forHTTPHeaderField:@"appVersion"];
    if (KUser.userId && KUser.isLogin) {
        [request setValue:KUser.userId forHTTPHeaderField:@"userId"];
    }
    [request setValue:[NSString stringWithFormat:@"iOS %@",device.systemVersion] forHTTPHeaderField:@"osVersion"];
    [request setValue:@"iOS" forHTTPHeaderField:@"osType"];
    [request setValue:[infoDic objectForKey:@"CFBundleIdentifier"] forHTTPHeaderField:@"appId"];
    [request setValue:[FCUUID uuidForDevice] forHTTPHeaderField:@"imei"];
    [request setValue:[[LocalizeHelper sharedLocalSystem] getRequestHeaderLanguageCode] forHTTPHeaderField:@"Accept-Language"];
    [request setValue:KConfigure.channel forHTTPHeaderField:@"channel"];
}
